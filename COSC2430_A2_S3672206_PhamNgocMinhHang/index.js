...
var ProductDetail = function (_React$Component) {
    ...
    function ProductDetail() {
        ...
        var _this = _possibleConstructorReturn(this, (ProductDetail.__proto__ || Object.getPrototypeOf(ProductDetail)).call(this));
    ...
    _createClass(ProductDetail, [{
        ...
        value: function componentWillReceiveProps(loadProduct) {
        ...
        value: function loadProduct(id) {
            ...
            fetch('http://rmit.chickenkiller.com:8080/products/' + id).then(function (res) {
                return res.json();
            }).then(function (product) {
                return _this2.props.dispatch({ type: 'FETCH_PRODUCT', payload: product });
...
var _ProductType = __webpack_require__(75);

var _ProductType2 = _interopRequireDefault(_ProductType);

var _ProductTypeForm = __webpack_require__(76);

var _ProductTypeForm2 = _interopRequireDefault(_ProductTypeForm);

var _ProductDetail = __webpack_require__(10);
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'li',
                            null,
                            _react2.default.createElement('a', { href: 'productDetail' })
                        )
                    )
                ),
                _react2.default.createElement(
                    'div',
                    null,
                    path.includes('Aboutus') ? _react2.default.createElement(_Aboutus2.default, null) : _react2.default.createElement(
                        'div',
                        null,
                        path.includes('List') ? _react2.default.createElement(
                            'div',
                            { className: 'container' },
                            _react2.default.createElement(
                                'div',
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'col-md-5' },
                                    _react2.default.createElement(_Form2.default, { dispatch: this.props.dispatch, editingProduct: this.props.editingProduct })
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'col-md-7' },
                                    _react2.default.createElement(_List2.default, { products: this.props.products, dispatch: this.props.dispatch,
                            ...
                            'div',
                            null,
                            path.includes('productType') ? _react2.default.createElement(
                                'div',
                                { className: 'container' },
                                _react2.default.createElement(
                                    'div',
                                    ...
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'col-md-5' },
                                        _react2.default.createElement(_ProductTypeForm2.default, { dispatch: this.props.dispatch, editingType: this.props.editingType })
                                    ),
                                    _react2.default.createElement(
                                        'div',
                                        { className: 'col-md-7' },
                                        _react2.default.createElement(_ProductType2.default, { dispatch: this.props.dispatch, types: this.props.types, editingType: this.props.editingType })
                                    )
                                )
                            ) : _react2.default.createElement(
                                'div',
                                null,
                                path.includes('productDetail') ? _react2.default.createElement(_ProductDetail2.default, { dispatch: this.props.dispatch, selectedProduct: this.props.selectedProduct }) : _react2.default.createElement(_HomePage2.default, { selectedProdutc: this.props.selectedProdutc, products: this.props.products, types: this.props.types, dispatch: this.props.dispatch })
                            ),
                            '   ',
...
var _ProductThumbnail = __webpack_require__(30);
...
var List = function (_React$Component) {
    ...
    _createClass(List, [{
        ...
        value: function loadProducts() {
            ...
            fetch('http://rmit.chickenkiller.com:8080/products').then(function (res) {
                return res.json();
            }).then(function (products) {
                return _this2.props.dispatch({ type: 'FETCH_PRODUCTS', payload: products });
            });
        }
    }, {
        key: 'deleteProduct',
        value: function deleteProduct(id) {
            ...
            if (confirm('Do you want to delete this product?')) {
                fetch('http://rmit.chickenkiller.com:8080/products/' + id, {
                    ...
                    _this3.props.dispatch({ type: 'DELETE_PRODUCT', payload: id });
                });
            }
        }
    }, {
        ...
        value: function showProducts() {
            return this.props.products.map(function (product) {
                return _react2.default.createElement(_ProductThumbnail2.default, { key: product._id, price: product.price, name: product.name, img: product.imageUrl });
            });
        }
    }, {
        key: 'editProduct',
        ...
        value: function render() {
            ...
            var listOfAllProducts = this.props.products.filter(function (s) {
                if (s.name !== 1) {
                    return s.name.toLowerCase().indexOf(_this4.state.keyword.toLowerCase()) !== -1;
                } else return _this4.props.products;
            });
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', name: 'keyword', className: 'form-control', value: this.state.keyword,
                ...
                listOfAllProducts.map(function (s) {
                    return _react2.default.createElement(
                        'p',
                        { key: s._id },
                        _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'button',
                            { className: 'btn btn-danger btn-md', onClick: _this4.deleteProduct.bind(_this4, s._id) },
                            'Delete'
                        ),
                        _react2.default.createElement(
                            'button',
                            { className: 'btn btn-primary btn-md', onClick: _this4.editProduct.bind(_this4, s) },
                            'Edit'
                        )
                    );
                })
...
var ProductThumbnail = function (_React$Component) {
    _inherits(ProductThumbnail, _React$Component);

    function ProductThumbnail() {
        _classCallCheck(this, ProductThumbnail);

        var _this = _possibleConstructorReturn(this, (ProductThumbnail.__proto__ || Object.getPrototypeOf(ProductThumbnail)).call(this));
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('img', { src: this.props.product.imageUrl, className: 'thumbnail-img', alt: this.props.product.name }),
                            _react2.default.createElement(
                                'div',
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { href: 'productDetail', className: 'btn btn-primary btn-md', onClick: this.viewDetail.bind(this, this.props.product._id) },
                                        'View Detail'
                                    )
                                )
                            )
...
var Form = function (_React$Component) {
    ...
    function Form() {
        ...
        _this.state = { id: '', name: '', brand: '', imageUrl: '',
    ...
    _createClass(Form, [{
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(newProduct) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'form',
                            { onSubmit: this.addProduct.bind(this), onReset: this.resetForm.bind(this) },
                            _react2.default.createElement(
                                'div',
                                ...
                                _react2.default.createElement('input', { type: 'text', name: 'name', className: 'form-control', value: this.state.name, onChange: this.handleChange.bind(this), placeholder: 'Enter name' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'form-group' },
                                ...
                                _react2.default.createElement('input', { type: 'text', name: 'price', className: 'form-control', value: this.state.price, onChange: this.handleChange.bind(this), placeholder: 'Enter price' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'form-group' },
                                ...
                                _react2.default.createElement('input', { type: 'text', name: 'brand', className: 'form-control', value: this.state.brand, onChange: this.handleChange.bind(this), placeholder: 'Enter brand' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'form-group' },
                                ...
                                _react2.default.createElement('input', { type: 'text', name: 'productType', className: 'form-control', value: this.state.productType, onChange: this.handleChange.bind(this), placeholder: 'Enter product type' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'form-group' },
                                ...
                                _react2.default.createElement('input', { type: 'text', name: 'imageUrl', className: 'form-control', value: this.state.imageUrl, onChange: this.handleChange.bind(this), placeholder: 'Enter image URL' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'form-group' },
                                ...
                                _react2.default.createElement('input', { type: 'text', name: 'producer', value: this.state.producer, className: 'form-control', onChange: this.handleChange.bind(this), placeholder: 'Enter producer' })
                            ),
                            _react2.default.createElement(
                                'div',
                                { className: 'form-group' },
                                ...
                                _react2.default.createElement('textarea', { type: 'text', name: 'description', className: 'form-control', value: this.state.description, onChange: this.handleChange.bind(this), placeholder: 'Enter description', rows: '3' })
                            ),
                            _react2.default.createElement(
                                'button',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              null,
              'Student Name: Pham Ngoc Minh Hang'
            ),
            _react2.default.createElement(
              'p',
              null,
...
var centralState = (0, _redux.combineReducers)({
    products: products, editingProduct: editingProduct, selectedProduct: selectedProduct, types: types, editingType: editingType
});
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(24), __webpack_require__(64)(module)))
    ...
    _createClass(Footer, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'container-fluid bg-4' },
                    _react2.default.createElement(
                        'div',
                        { className: 'row' },
                        _react2.default.createElement(
...
var List = function (_React$Component) {
    ...
    _createClass(List, [{
        ...
        value: function loadTypes() {
            ...
            fetch('http://rmit.chickenkiller.com:8080/productTypes').then(function (respon) {
                return respon.json();
            }).then(function (types) {
                return _this3.props.dispatch({ type: 'FETCH_TYPES', payload: types });
            });
        }
    }, {
        key: 'viewDetail',
        ...
        key: 'onCategories',
        value: function onCategories(type) {
            console.log(type);
        ...
        value: function render() {
            ...
            var listOfAllProducts = this.props.products.filter(function (s) {
                if (_this4.state.filterType === 'search') {
                    return s.name.toLowerCase().indexOf(_this4.state.keyword.toLowerCase()) !== -1;
                }
                if (_this4.state.filterType === 'filterProduct')
                    // {return s.productType.indexOf(this.state.keyword)!==-1 }
                    {
                        return s.productType.toLowerCase().indexOf(_this4.state.filterid.toLowerCase()) !== -1;
                    } else return _this4.props.products;
            });
            // pass var to the child component
            var productGridList = listOfAllProducts.map(function (product) {
                return _react2.default.createElement(_ProductThumbnail2.default, { key: product._id
                    // productID ={product._id} price={product.price} name={product.name}
                    // img={product.imageUrl} 
                    , product: product, selectedProdutc: _this4.props.selectedProdutc,
                    type: _this4.state.type, style: _this4.state.style });
            });
                ...
                _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'a',
                                                { 'data-toggle': 'collapse', onClick: this.loadTypes.bind(this), 'data-parent': '#accordion', href: '#collapse1' },
                                                'Product'
                                            )
                                        )
                                    ),
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            this.props.types.map(function (s) {
                                                return _react2.default.createElement(
                                                    'ul',
                                                    { key: s._id },
                                                    _react2.default.createElement(
                                                        'button',
                                                        { onClick: _this4.onCategories.bind(_this4, s.name), className: 'list-group-item' },
                                                        s.name
                                                    )
                                                );
                                            })
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'a',
                                                { className: 'list-group-item', onClick: this.priceFilter.bind(this) },
                                                ' Low to High'
                                            ),
                                            _react2.default.createElement(
                                                'a',
                    ...
                    _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'button',
                                            { type: 'button', className: 'btn btn-primary', onClick: this.onSearch.bind(this) },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'button',
                                { type: 'button', className: 'btn btn-default btn-sm', onClick: this.selectGrid.bind(this) },
                                _react2.default.createElement('span', { className: 'glyphicon glyphicon-th' }),
                                ' Grid'
                            ),
                            _react2.default.createElement(
                                'button',
                                { type: 'button', className: 'btn btn-default btn-sm', onClick: this.selectList.bind(this) },
...
var ProductType = function (_React$Component) {
    _inherits(ProductType, _React$Component);

    function ProductType() {
        _classCallCheck(this, ProductType);

        var _this = _possibleConstructorReturn(this, (ProductType.__proto__ || Object.getPrototypeOf(ProductType)).call(this));
    ...
    _createClass(ProductType, [{
        ...
        value: function loadProductTypes() {
            ...
            fetch('http://rmit.chickenkiller.com:8080/productTypes').then(function (res) {
                return res.json();
            }).then(function (types) {
                return _this2.props.dispatch({ type: 'FETCH_TYPES', payload: types });
            });
        }
    }, {
        key: 'deleteType',
        value: function deleteType(id) {
            ...
            if (confirm('Do you want to delete this product type?')) {
                fetch('http://rmit.chickenkiller.com:8080/productTypes/' + id, {
                    ...
                    _this3.props.dispatch({ type: 'DELETE_TYPE', payload: id });
                });
            }
        }
    }, {
        key: 'editProductType',
        value: function editProductType(type) {
            console.log(type);
        ...
        value: function render() {
            ...
            var listOfAllTypes = this.props.types;
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(
                    ...
                    listOfAllTypes.map(function (s) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'panel panel-default panelType', key: s._id },
                            _react2.default.createElement(
                                'div',
                                { className: 'panel-heading' },
                                _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { className: 'btn btn-danger btn-sm', onClick: _this4.deleteType.bind(_this4, s._id) },
                                    'Delete'
                                ),
                                _react2.default.createElement(
                                    'button',
                                    { className: 'btn btn-primary btn-sm', onClick: _this4.editProductType.bind(_this4, s) },
                                    'Edit'
                                )
                            )
                        );
...
var Form = function (_React$Component) {
    ...
    _createClass(Form, [{
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(newType) {
        ...
        value: function addType(e) {
            ...
            fetch('http://rmit.chickenkiller.com:8080/productTypes', {
                ...
                _this2.props.dispatch({
                    type: 'ADD_TYPE',
                    payload: data });
            }).then(alert('Added new product type')).then(this.setState({
                name: ''
            }));
        }
    }, {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'form',
                            { onSubmit: this.addType.bind(this), onReset: this.resetForm.bind(this) },
                            _react2.default.createElement(
                                'div',
                                { className: 'form-group' },
                                _react2.default.createElement(
